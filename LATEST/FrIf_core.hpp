...
#define FRIF_COREFUNCTIONALITIES_VIRTUAL                                       \
      ...
      virtual FUNC(void, FRIF_CODE) AbortCommunication        (void) = 0;      \
      ...
      virtual FUNC(void, FRIF_CODE) CancelAbsoluteTimer       (void) = 0;      \
      virtual FUNC(void, FRIF_CODE) CancelRelativeTimer       (void) = 0;      \
      ...
      virtual FUNC(void, FRIF_CODE) GetNmVector               (void) = 0;      \
